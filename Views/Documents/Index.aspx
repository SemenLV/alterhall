		...
		<div class="col-xs-12">
			...
			<div id="mainDocs">
				...
				що здійснює державне регулювання у сферах енергетики та комунальних послуг»" target="_blank">
					...
					<li>
						<a href="https://zakon.rada.gov.ua/laws/show/v0312874-18#Text" target="_blank">
							Правила роздрібного ринку електричної енергії</a>
					</li>

					<li>
						<a href="https://zakon.rada.gov.ua/laws/show/v0307874-18#Text" title="Про затвердження Правил ринку" target="_blank">
							Про затвердження Правил ринку</a>
					</li>

					<li>
						<a href="https://zakon.rada.gov.ua/laws/show/v0308874-18#Text" title="Про затвердження Правил ринку «на добу наперед» та внутрішньодобового ринку" target="_blank">
							Про затвердження Правил ринку «на добу наперед» та внутрішньодобового ринку</a>
					</li>
				</ul>
			</div>
		</div>
