				...
				<div class="row">
					...
					<div class="col-sm-3 text-center wow bounceIn">
						...
						<span class="step">
							Крок 2</span>
						<br />
						Електропостачальник укладає з місцевою енергопередавальною організацією (-обленерго)
						Договір про передачу електричної енергії її мережами до Споживачів електропостачальника
					</div>
					<div class="col-sm-3 text-center wow bounceIn">
					...
					<div class="adventage-text-1 ">
						<div class="adventage-text-border">
							...
							<span class="hidden-xs">
								...
								обсяги споживання та графік оплат.</span>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="adventage-text-2 ">
						<div class="adventage-text-border">
							...
							<span class="hidden-xs">
								...
								місяці. Ми запропонуємо Вам найкомфортніші для Вас графіки платежів.</span>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="adventage-text-3">
						<div class="adventage-text-border">
							...
							<span class="hidden-xs">
								...
								в будь-якій ситуації. Ми проконсультуємо Вас з будь-яких питань в галузі енергетики.</span>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-xs-12 col-sm-offset-4 col-sm-8">
					<div class="adventage-text-4">
						<div class="adventage-text-border">
							...
							<br />
							<span class="hidden-xs">
								Ми ставимось з розумінням до кожного клієнта, а тому у Вас завжди буде можливість
								відкоригувати договірні величини споживання електричної енергії. Також ми лояльні
								в частині нарахування штрафних санкцій за перевищення договірних величин споживання
								електричної енергії. Ми погодимо індивідуальні відтермінування оплат за спожиту
								електроенергію у разі виникнення непередбачуваних обставин.</span>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="howToStart" class="section">
			...
			<div class="wow bounceIn">
				<div class="box">
					...
					<div class="box-body">
						<p>
							Звʼяжіться з нами та заповніть заявку на сайті
							<%--Заявка складається з Анкети та Опитувального листа, які містять коротку інформацію про споживача, стан його енергетичного господарства та режими його роботи.--%>
						</p>
					</div>
				</div>
				<div class="box">
					...
					<div class="box-body">
						<p>
							Ми розрахуємо для Вас розмір індивідуальної знижки.</p>
					</div>
				</div>
				<div class="box">
					<div class="box-top">
					...
					<div class="box-body">
						<p>
							Оформлення необхідних документів</p>
					</div>
				</div>
				<div class="box">
					<div class="box-top">
					...
					<div class="box-body">
						<p>
							Укладення договору про купівлю-продаж електоенергії.
						</p>
					</div>
				</div>
				<div class="box">
					...
					<div class="box-body">
						<p>
							100% дотримання усіх зобов'язань</p>
					</div>
				</div>
			</div>
			<div class="wow fadeInUp text-center">
