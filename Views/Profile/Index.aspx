...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div class="row" style="margin-bottom:30px;">
		<div class="col-xs-12">
			...
			<br />
				<input type="hidden" id="txtMailTo" name="mailto" value="alterhol@ukr.net" />
				<div>
			...
			<p>
				Зателефонувавши за номером 032 247 7 247 Ви отримаєте інформацію про :
			</p>
			<ul class="list-group">
				<li>
			...
			<p>
				Дзвінки на номер: (032)247 7 247 тарифікуються за розцінками Вашого оператора
			</p>
			<p>
